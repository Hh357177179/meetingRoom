...
(function () {
  ...
  Frame = (function () {
    ...
    Frame._unmarshallSingle = function (data) {
      ...
      line = idx = null
      for (i = _i = 0, _ref = headerLines.length; _ref >= 0 ? _i < _ref : _i > _ref; i = _ref >= 0 ? ++_i : --_i) {
        line = headerLines[i]
        idx = line.indexOf(':')
  ...
  Client = (function () {
    ...
    Client.prototype.debug = function (message) {
      var _ref
      return typeof window !== 'undefined' && window !== null ? (_ref = window.console) != null ?
        _ref.log(message) : void 0 : void 0
    }
    ...
    Client.prototype._setupHeartbeat = function (headers) {
      ...
      _ref1 = (function () {
        var _ref1 = headers['heart-beat'].split(',')
        var _results = []
      ...
      if (!(this.heartbeat.incoming === 0 || serverOutgoing === 0)) {
        ...
        this.ponger = typeof window !== 'undefined' && window !== null ? window.setInterval(function () {
